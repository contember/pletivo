/**
 * Content collections shim — wraps Astro's content API to match pavouk's API.
 *
 * This module is aliased from `pavouk` imports so that the same page code
 * works in both pavouk and Astro.
 *
 * import { getCollection, getEntry } from "pavouk";
 * // In pavouk: uses pavouk's own content system
